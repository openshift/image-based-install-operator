...
func (r *ImageClusterInstallReconciler) validateBMHMachineNetworks(
	...
	effectiveNetworks := getEffectiveMachineNetworksCIDRs(legacyMachineNetwork, machineNetworks)
...
func getEffectiveMachineNetworksCIDRs(legacyMachineNetwork string, machineNetworks []v1alpha1.MachineNetworkEntry) []string {
