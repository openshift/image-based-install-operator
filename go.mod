...
require (
	...
	github.com/openshift-kni/lifecycle-agent e165a6bcc716
...
replace (
	github.com/metal3-io/baremetal-operator/apis => github.com/openshift/baremetal-operator/apis v0.0.0-20240611081634-a92cc4b9ae8b
