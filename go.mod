...
require (
	...
	github.com/openshift/cluster-api-provider-libvirt v0.2.1-0.20251110153637-76effeca10bc // indirect
...
replace (
	// github.com/openshift/installer replacements to keep compatibility with the required modules.
	github.com/openshift/assisted-service/api => github.com/openshift/assisted-service/api v0.0.0-20250625193139-474abcbea19a
