...
require (
	...
	github.com/openshift/library-go v0.0.0-20241216140520-201d816c66f0 // indirect
...
replace (
	...
	github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models 0889f438699f
