...
require (
	...
	github.com/openshift/hive/apis v0.0.0-20260225192751-418c958779ff
...
require (
	...
	github.com/openshift/assisted-image-service v0.0.0-20260218195442-98909092655f // indirect
